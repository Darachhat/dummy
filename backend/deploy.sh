...
if [ "$CI_COMMIT_REF_NAME" = "dev" ]; then
  DEPLOY_SERVER=$DEPLOY_DEV_SERVER
  ENVIRONMENT="dev"
  NAMESPACE="dev"
  HOST_USER=$DEV_USER
  ANSIBLE_INVENTORY=$DEV_ANSIBLE_INVENTORY
  ENV="dev"
  URL=$DEV_URL
  SUDO_PASSWORD=$DEV_SUDO_PWD
  ...
  ENV="staging"
  URL=$STAGING_URL
  SUDO_PASSWORD=$STAGING_SUDO_PWD
...
echo "SERVICE_REPLICAS: $SERVICE_REPLICAS"
echo "=================================="
